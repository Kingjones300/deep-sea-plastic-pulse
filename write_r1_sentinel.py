...
with open("scripts/phase1_data/01_download_sentinel2_R1.py", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("R1 Sentinel-2 download script written OK")
print(open("scripts/phase1_data/01_download_sentinel2_R1.py", encoding="utf-8").read()[:200])