...
os.makedirs("scripts/phase5_validation", exist_ok=True)
with open("scripts/phase5_validation/01_validate_R1.py", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("R1 validation script written OK")
print(open("scripts/phase5_validation/01_validate_R1.py", encoding="utf-8").read()[:200])