...
os.makedirs("scripts/phase2_classifier", exist_ok=True)
with open("scripts/phase2_classifier/01_train_classifier_R1.py", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("R1 classifier script written OK")
print(open("scripts/phase2_classifier/01_train_classifier_R1.py", encoding="utf-8").read()[:200])