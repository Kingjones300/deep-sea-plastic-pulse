...
os.makedirs("scripts/phase4_corridors", exist_ok=True)
with open("scripts/phase4_corridors/01_detect_corridors_R1.py", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("R1 corridors script written OK")
print(open("scripts/phase4_corridors/01_detect_corridors_R1.py", encoding="utf-8").read()[:200])