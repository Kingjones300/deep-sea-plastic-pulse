...
os.makedirs("scripts/phase3_lagrangian", exist_ok=True)
with open("scripts/phase3_lagrangian/01_run_lagrangian_R1.py", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("R1 Lagrangian script written OK")
print(open("scripts/phase3_lagrangian/01_run_lagrangian_R1.py", encoding="utf-8").read()[:200])