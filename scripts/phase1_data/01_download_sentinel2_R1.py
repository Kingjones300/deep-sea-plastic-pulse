...
"""
Phase 1 - Script 01
Sentinel-2 Smart Seasonal Download for Region R1
...
setup_logging("01_download_sentinel2_R1")
...
TARGET_TILES = ["47NMH", "47NNH", "48NTG", "48NUG", "48NUH", "48NVH", "49NCA", "49NCB"]
...
def main():
    config = load_config()
    out_dir = ensure_dir(
        Path(config.get("SENTINEL2_DIR", "outputs/sentinel2")) / "R1"
    )
    ...
    logger.info("Region:  R1 Strait of Malacca")
