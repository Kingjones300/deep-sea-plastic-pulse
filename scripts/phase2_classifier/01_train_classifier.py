...
OUT_DIR = ROOT / "outputs" / "results" / "phase2"
...
try:
    ...
    plt.title("SHAP Feature Importance - W4 Critical Sinking State")
    plt.tight_layout()
...
# 5. Save outputs
print("\n[5/5] Saving outputs...")
model.save_model(str(OUT_DIR / "xgboost_weathering_model.json"))
...
ax.set_title("Confusion Matrix W1-W4")
for i in range(4):
    for j in range(4):
